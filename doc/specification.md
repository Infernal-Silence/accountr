...
```
Примечания:
- Если такой пользователь уже был создан ранее, также возвращает пользователя и код **200**
...
```
Примечания:
- Если указан неверный логин, возвращает код ошибки 403
- Если указан неверный пароль, возвращает код ошибки 401
...
- Если удаляемой категории не существует, вовзращает код ошибки 404
